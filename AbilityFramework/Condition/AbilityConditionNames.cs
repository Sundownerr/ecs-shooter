...
{
    public static class AbilityConditionNames
    {
        ...
        {
            _nameToType = AbilityConditionToTypeMap.Create().ToDictionary(x => x.Item1, x => x.Item2);
            return _nameToType;
        }
        ...
        public static IEnumerable NamesInGroup(int group)
        {
            ...
            foreach (var key in NameToType[group].Keys)
                dropdownItems.Add(ConditionId.ToName[key], key);
