...
namespace Game.Systems
{
    ...
    public sealed class NpcAction_IdleSystem : ISystem
    {
        private Filter _filter;
        private Stash<UserEntity> _userEntityStash;
        private Stash<NpcState_Idle> _npcStateIdleStash;
        ...
        public void OnAwake()
        {
            _filter = Entities.With<NpcAction_Idle, Active>();
            _userEntityStash = World.GetStash<UserEntity>();
            _npcStateIdleStash = World.GetStash<NpcState_Idle>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter)
            {
                ...
                _npcStateIdleStash.Add(user.Entity);
