...
namespace Game.Systems
{
    ...
    public sealed class CrosshairHitAnimationSystem : ISystem
    {
        private readonly PlayerUIProvider _playerUi;
        private Stash<DamageApplied> _damageApplied;
        private Filter _filter;

        public CrosshairHitAnimationSystem(ServiceLocator serviceLocator)
        {
        ...
        public void OnAwake()
        {
            _filter = Entities.With<Npc, HasBeenDamaged>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter) {
                ...
                if (damage.LastDamageDealer is DamageDealerType.Player)
                    _playerUi.PlayCrosshairHitAnimation();
            }
        }
    }
}