...
namespace Game.Systems
{
    ...
    public sealed class CheckTransitionConditionsSystem : ISystem
    {
        ...
        private Stash<ForwardConditionsToMeet> _conditionsToMeet;
        ...
        public void OnAwake()
        {
            _filter = Entities.With<Transition, ForwardConditionsToMeet, Active>();

            // Initialize stashes
            _transition = World.GetStash<Transition>();
            _stateMachineExitTime = World.GetStash<StateMachineExitTime>();
            _conditionsToMeet = World.GetStash<ForwardConditionsToMeet>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter)
            {
                ...
                ref var conditionsToMeet = ref _conditionsToMeet.Get(entity);
