...
namespace Game.Systems
{
    ...
    public sealed class DeactivateStateInstantUsageSystem : ISystem
    {
        ...
        public void OnAwake()
        {
            _filter = Entities.With<NeedsActivation, UsageProgress, InstantActions>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter)
            {
                ...
                _active.Remove(usageProgress.Entity);
            }
        }
    }
}
