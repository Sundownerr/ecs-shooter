...
namespace Game.Systems
{
    ...
    public sealed class Check_PrimaryAttackReleasedSystem : ISystem
    {
        ...
        public void OnAwake()
        {
            _filter = Entities.With<CheckPrimaryAttackReleased, Active>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter)
            {
                ...
                if (!_primaryAttackWasReleased.Has(user.Entity))
                    continue;

                ref var primaryAttackWasReleased = ref _primaryAttackWasReleased.Get(user.Entity);

                if (!primaryAttackWasReleased.Value)
                    continue;
