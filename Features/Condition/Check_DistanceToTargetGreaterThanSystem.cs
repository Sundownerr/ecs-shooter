...
namespace Game.Systems
{
    ...
    public sealed class Check_DistanceToTargetGreaterThanSystem : ISystem
    {
        private Stash<ConditionFulfilled> _conditionFulfilled;
        private Stash<DistanceToTargetGreaterThan> _distanceToTargetGreaterThan;
        ...
        public void OnAwake()
        {
            _filter = Entities.With<DistanceToTargetGreaterThan, Active>();
            ...
            _distanceToTargetGreaterThan = World.GetStash<DistanceToTargetGreaterThan>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter) {
                ...
                foreach (var targetEntity in targets.List) {
                    ...
                    ref var condition = ref _distanceToTargetGreaterThan.Get(entity);
