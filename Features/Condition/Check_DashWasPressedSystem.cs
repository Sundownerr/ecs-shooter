...
namespace Game.Systems
{
    ...
    public sealed class Check_DashWasPressedSystem : ISystem
    {
        ...
        public void OnAwake()
        {
            _filter = Entities.With<CheckDashWasPressed, Active>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter)
            {
                ...
                ref var dashWasPressed = ref _dashWasPressed.Get(user.Entity);

                if (!dashWasPressed.Value)
                    continue;
