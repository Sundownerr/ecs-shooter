...
namespace Game.Systems
{
    ...
    public sealed class Action_RegenerateFullManaSystem : ISystem
    {
        // Stashes for component access
        private Stash<AbilityRegenerateFullMana> _abilityRegenerateFullMana;
        ...
        public void OnAwake()
        {
            _filter = Entities.With<AbilityRegenerateFullMana, Active>();

            // Initialize stashes
            _abilityRegenerateFullMana = World.GetStash<AbilityRegenerateFullMana>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter) {
                ...
                if (!World.IsDisposed(targetEntity) && _floatStats.Has(targetEntity)) {
                    ...
                    floatStats.Value.Set(Stat.Mana, floatStats.Value.ValueOf(Stat.MaxMana));
                }
