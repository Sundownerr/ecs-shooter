...
namespace Game.Systems
{
    ...
    public sealed class Action_RemoveFloatStatModifierSystem : ISystem
    {
        // Stashes for component access
        private Stash<AbilityRemoveFloatStatModifier> _abilityRemoveFloatStatModifier;
        ...
        public void OnAwake()
        {
            _filter = Entities.With<AbilityRemoveFloatStatModifier, Active>();

            // Initialize stashes
            _abilityRemoveFloatStatModifier = World.GetStash<AbilityRemoveFloatStatModifier>();
        ...
        public void OnUpdate(float deltaTime)
        {
            foreach (var entity in _filter) {
                ...
                if (!World.IsDisposed(targetEntity) && _floatStats.Has(targetEntity)) {
                    ...
                    floatStats.Value.RemoveModifier(removeModifier.StatId, removeModifier.ModifierId);

                    // Debug.Log( $"Remove modifier {removeModifier.ModifierId} from {targetEntity}" );
                }
